...
{
    public class Historia : Preguntas
    {
        public Historia(string Pregunta, string OpcionA, string OpcionB, string OpcionC, string OpcionD, string OpcionCorrecta, string OpcionJugador, bool YaSePregunto) : base(Pregunta, OpcionA, OpcionB, OpcionC, OpcionD, OpcionCorrecta, OpcionJugador, YaSePregunto)
        {
        }
